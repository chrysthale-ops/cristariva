/* CRISTARIVA — construction du Tarot 78 cartes à partir des 56 arcanes mineurs. */
(function(){
'use strict';
if(!window.TAROT_DATA||!Array.isArray(window.TAROT_DATA.main))return;
const rows=window.CR_TAROT_MINOR_ROWS||[];
...
window.CR_TAROT_DIVINATOIRE_VERSION='2026.09.24-tarot78';
window.CR_TAROT_MINOR_COUNT=56;
})();
